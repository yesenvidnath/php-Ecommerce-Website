...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      <div class="row">
         ...
         <div class="col-6">
           <input style="background:#008140;" type="submit" name="order" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>" value="Cash on delivery">
         </div>
         ...
         <div class="col-6">
            ...
            <br>
            <center><div id="paypal-button-container" style="max-width:300px;"></div></center>
